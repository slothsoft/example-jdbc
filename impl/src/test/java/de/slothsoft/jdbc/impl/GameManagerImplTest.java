...
public class GameManagerImplTest {
	...
	public void testGet() throws GameException {
		final Game game = this.gameManager.createGame(new Game("Gotten Game", 2000));
		final Game gottenGame = this.gameManager.getGame(game.getId());
	...
	public void testUpdate() throws GameException {
		...
		final Game updatedGame = this.gameManager.updateGame(createdGame);
	...
	public void testFind() throws GameException {
		...
		final Game[] foundGames = this.gameManager.findGames();
	...
	public void testDelete() throws GameException {
		final Game game = this.gameManager.createGame(new Game("Game 1", 2001));
